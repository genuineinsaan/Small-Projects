...
if __name__ == '__main__':
    ...
    LABLE1.place(x=55, y=150)
    ENTRY1 = Entry(TOP, bd=6, width=6, font="Roboto 11")
    ENTRY1.place(x=600, y=150)
    
    LABLE2 = Label(TOP, bg="#cef0f1", text="Enter Height (in cm):", bd=6,
                   font=("Helvetica", 10, "bold"), pady=5)
    LABLE2.place(x=55, y=250)
    ENTRY2 = Entry(TOP, bd=6, width=6, font="Roboto 11")
    ENTRY2.place(x=600, y=250)
    
    
    LABLE3 = Label(TOP, bg="#cef0f1", text="Enter Age (in year):", bd=6,
                   font=("Helvetica", 10, "bold"), pady=5)
    LABLE3.place(x=55, y=350)
    ENTRY3 = Entry(TOP, bd=6, width=6, font="Roboto 11")
    ENTRY3.place(x=600, y=350)
    
    BUTTON = Button(bg="#2187e7", bd=12, text="Calculate BMI", padx=33, pady=15, command=calculate_bmi,
